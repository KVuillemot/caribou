...
class HyperelasticForcefield_Phi_FEM : public CaribouForcefield<Element> {
public:
    SOFA_CLASS(SOFA_TEMPLATE(HyperelasticForcefield_Phi_FEM, Element), SOFA_TEMPLATE(CaribouForcefield, Element));
    ...
    using Link = sofa::core::objectmodel::SingleLink<HyperelasticForcefield_Phi_FEM<Element>, ObjectType, sofa::core::objectmodel::BaseLink::FLAG_STRONGLINK>;

    
    // Public methods

    
    HyperelasticForcefield_Phi_FEM();
...
private:
    ...
    Link<topology::FictitiousGrid<DataTypes>> d_grid;
